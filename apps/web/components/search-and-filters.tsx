      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-12 shadow-none"
          />
          {filters.search && (
            <button
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Popover open={showFilters} onOpenChange={setShowFilters}>
          <PopoverTrigger asChild>
            ...
            >
              ...
              {hasActiveFilters && (
                <Badge
                  variant="secondary"
                  className="ml-1 px-1.5 py-0.5 text-xs shadow-none"
                >
                  {[
          ...
          <PopoverContent
            className="w-80 shadow-none border border-border bg-card"
            align="start"
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={filters.readStatus}
                  onValueChange={(value) =>
                    updateFilters({ readStatus: value })
                  }
                >
                  <SelectTrigger className="shadow-none">
                    <SelectValue />
        ...
        {filters.readStatus !== "all" && (
          <Badge variant="secondary" className="gap-1 shadow-none">
            ...
            {filters.readStatus === "read" ? "Read" : "Unread"}
            <button onClick={() => updateFilters({ readStatus: "all" })}>
              <X className="h-3 w-3" />
            </button>
          </Badge>
        )}
